...
///左右限隙宏
#define SIZE_DEFAULT_MARGIN_LEFT_RIGHT (SIZE_DEVICE_WIDTH > 320.0f ? 15.0f : 10.0f)

///首页横幅高度
#define SIZE_DEFAULT_HOME_BANNAR_HEIGHT (SIZE_DEVICE_HEIGHT * 200.0f / 667.0f-50.0f)
